...
def main(split_config_path, windows_config_path, model_config_path, window_filter=None):
    ...
    print("=" * 60)
    print("Training XGBoost with LODO-CV")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config",   type=str, default="configs/xgb_config.yaml")
