...
def main(split_config_path, windows_config_path, model_config_path, window_filter=None):
    ...
    print("=" * 60)
    print("Training SVM with LODO-CV")
    ...
    for window_cfg in windows:
        ...
        for fold_cfg in folds:
            ...
            # Save model locally
            models_dir = Path("artifacts/models/svm")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config",   type=str, default="configs/svm_config.yaml")
