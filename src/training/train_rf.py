# src/models/ml/train_rf.py
# ========================
# Trains a Random Forest model with LODO-CV
# Tracks experiments using Weights & Biases (W&B)
# One W&B run per window (consistent with all other models)
#
# Run with:
#   python -m src.training.train_rf --window w5s
...
def main(split_config_path, windows_config_path, model_config_path, window_filter=None):
    ...
    print("=" * 60)
    print("Training Random Forest with LODO-CV")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config",   type=str, default="configs/rf_config.yaml")
